...
--- | --- | --- | --- | --- | ---
1 | rexona | <img src="/blob/main/src/assets/sprites/Itens/RexonnaSpritesheet.png"> | ele pode ser obtido no início da cena 3 | aumentar a força do personagem | não tem
