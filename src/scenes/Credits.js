export default class CreditScreen extends Phaser.Scene {
  ...
  create() {
    ...
    this.add.text(415, 285, "                Integrantes do Grupo:\n (clique nos nomes para ver os linkedins!)", { font: "bold 25px poppins", color: "#000000", stroke: "#ffffff", strokeThickness: 4});
    //this.add.text(520, 320, "clique nos nomes para ver os linkedins!", {font: "15px poppins" });
    this.add // Raphael
      .text(480, 370, "Raphael Silva - Programação", { font: "bold 25px poppins",  color: "#000000", stroke: "#ffffff", strokeThickness: 4 })
      .setInteractive()
      .on("pointerdown", () => {
        window.open("https://www.linkedin.com/in/raphaelfelipesilva/");
      });
    this.add // Igor
      .text(485, 405, "Igor Sampaio Silva - Design", { font: "bold 25px poppins",  color: "#000000", stroke: "#ffffff", strokeThickness: 4 })
      .setInteractive()
      .on("pointerdown", () => {
        window.open("https://www.linkedin.com/in/igor-sampaio-silva/");
      });
    this.add // Thiago
      .text(468, 440, "Thiago Volcati - Documentação", { font: "bold 25px poppins",  color: "#000000", stroke: "#ffffff", strokeThickness: 4 })
      .setInteractive()
      .on("pointerdown", () => {
        window.open("https://www.linkedin.com/in/thiago-volcati-a42a94208/");
      });
    this.add // David
      .text(468, 475, "David Deodato - Documentação", { font: "bold 25px poppins",  color: "#000000", stroke: "#ffffff", strokeThickness: 4 })
      .setInteractive()
      .on("pointerdown", () => {
        window.open("https://www.linkedin.com/in/david-deodato-41b9b72b7/");
      });
    this.add // Otávio
      .text(455, 510, "Otávio Vasconcelos - Programação", { font: "bold 25px poppins",  color: "#000000", stroke: "#ffffff", strokeThickness: 4 })
      .setInteractive()
      .on("pointerdown", () => {
        window.open(
    ...
    this.add // Marlos
      .text(515, 545, "Marlos Guedes - Design", { font: "bold 25px poppins",  color: "#000000", stroke: "#ffffff", strokeThickness: 4 })
      .setInteractive()
      .on("pointerdown", () => {
        window.open(
    ...
    this.add // Ricardo
      .text(515, 580, "Ricardo Planas - Design", { font: "bold 25px poppins",  color: "#000000", stroke: "#ffffff", strokeThickness: 4 })
      .setInteractive()
      .on("pointerdown", () => {
